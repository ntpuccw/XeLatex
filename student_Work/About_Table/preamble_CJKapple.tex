...
%\usepackage[left=1.5in,right=1in,top=1in,bottom=1in]{geometry} %改頁面的呈現長寬
%-----------------------------------------------------------------------------------------------------------------------
%  主字型設定
\setCJKmainfont
	[
...
\setmonofont{Corbel}										% used with {\ttfamily ...}
%\setmonofont[Scale=MatchLowercase]{Andale Mono}
% 其他字型（隨使用的電腦安裝的字型不同，用註解的方式調整（打開或關閉））
% 英文字型
\newfontfamily{\E}{Times New Roman}										% 套用在內文中所有的英文字母
\newfontfamily{\A}{Arial}[Scale=0.9]
\newfontfamily{\C}{Corbel}
\newfontfamily{\TT}[Scale=0.9]{Times New Roman}
\newfontfamily{\G}{Monaco}  
...
%\newCJKfontfamily{\M}{新細明體} 	
%-----------------------------------------------------------------------------------------------------------------------
\XeTeXlinebreaklocale "zh"                  				%這兩行一定要加，中文才能自動換行
\XeTeXlinebreakskip = 0pt plus 1pt     %這兩行一定要加，中文才能自動換行
%-----------------------------------------------------------------------------------------------------------------------
\newcommand{\cw}{\texttt{cw}\kern-.6pt\TeX}	% 這是 cwTex 的 logo 文字
\newcommand{\imgdir}{images/}						% 設定圖檔的位置 從目前的目錄找到images的資料夾
\renewcommand{\tablename}{表}						% 改變表格標號文字為中文的「表」（預設為 Table）
\renewcommand{\figurename}{圖}						% 改變圖片標號文字為中文的「圖」（預設為 Figure）
\definecolor{slight}{gray}{0.8}								% 定義顏色
%\renewcommand{\refname}{參考文獻}					% 改變文字為中文的「參考文獻」（預設為 Referances）